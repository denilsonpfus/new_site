node {
    ...
    stage ('Launch docker containers') {
      ...
      // Lauch website container here
           sh "docker run -v /home/denferreira/new_site:/data --name new_site denilsonpfus/website”
      // Lauch Apache container here
           sh "docker run -d -P --volumes-from new_site --name apache_server${env.BUILD_NUMBER} denilsonpfus/apache"
